// Maps project frontmatter category labels (TH + EN) to the sector slugs used by
// the projects filter. Type labels such as "Web Application" are not sectors.
const SECTOR_BY_LABEL = {
  'การศึกษา': 'education',
  Education: 'education',
  'ความเป็นอยู่': 'livelihood',
